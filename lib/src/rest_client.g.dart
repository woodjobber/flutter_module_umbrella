...
class _RestClient implements RestClient {
  ...
  @override
  Future<ApiResult<Task?>> getNestApiResultGenericsInnerTypeNullable() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<List<Task?>> getAutoCastGenericsInnerTypeNullable() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    ...
    var value = _result.data!
        .map((dynamic i) =>
            i == null ? null : Task.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }

  @override
  Future<List<String>> getTags({String? optionalHeader}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<void>> responseWith204() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<List<String?>>>
      getNestAutoCastBasicInnerTypeNullable() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<List<String?>>>
      getAutoCastBasicInnerTypeNullable() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  Future<String> postFormData(
    ...
    _data.fields.add(MapEntry(
      'task',
      jsonEncode(task ?? <String, dynamic>{}),
    ));
    _data.files.add(MapEntry(
      'file',
      MultipartFile.fromFileSync(
  ...
  @override
  Future<String> postFile({required File file}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
  ...
  Future<ValueWrapper<ValueWrapper<String>>> nestGeneric() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ValueWrapper<ValueWrapper<String>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<String> genericBase(ValueWrapper<String> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<String> genericOther(ValueWrapper<TaskQuery> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<String> genericMap(ValueWrapper<Map<String, dynamic>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<String> genericListBase(ValueWrapper<List<String>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<String> genericListOther(ValueWrapper<List<TaskQuery>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<String> genericListGeneric(
      ValueWrapper<List<ValueWrapper<TaskQuery>>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<String> nestedGenericBase(
      ValueWrapper<ValueWrapper<String>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<String> nestedGenericOther(
      ValueWrapper<ValueWrapper<TaskQuery>> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
